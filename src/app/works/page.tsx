      ...
      <main className="bg-white min-h-screen pt-40 pb-24 px-4 md:px-6">
        <div className="container mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
            {loading ? (
              <div className="col-span-full text-center py-20 text-accent-dark">Loading archive...</div>
              ...
              <div className="col-span-full text-center py-20 text-accent-dark/60 text-xl border border-dashed border-accent-dark/20 rounded-3xl">
